...
public class WinningNumbers extends Numbers {
    ...
    public Prize checkWinning(Numbers autoGeneratedTicketNumbers) {
        int matchCount = autoGeneratedTicketNumbers.match(this);
        if (matchCount <= 2) {
            return Prize.NOTHING;
        }
        return Prize.of(matchCount, autoGeneratedTicketNumbers.contains(bonusNumber));
    }
